...
/**
 * Checks that a numeric source is greater than or equal to expected value.
 */
public class GePredicate implements BiPredicate<Object, Object> {
    /**
     * Evaluates greater-than-or-equal for BigDecimal inputs.
     *
     * @param target source value
     * @param expected expected value
     * @return {@code true} when target is greater than or equal to expected
     */
    @Override
